...
**Requires Accessibility permission.** macOS needs permission for ExtraDock to control other app windows. You'll be prompted to grant access in System Settings → Privacy & Security → Accessibility.

Without the permission, clicks fall back to normal open/activate behavior.
